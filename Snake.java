...
import static TheGraphGrades.Rectangle.rec_height;
import static TheGraphGrades.Rectangle.rec_width;
...
public class Snake extends JPanel {
    ...
    public Snake(TheGraphGrades.Main window) {
        this.window = window;
